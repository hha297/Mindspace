      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-2">
            <IconComponent className={`h-5 w-5 ${getCategoryColor(currentQuote.category)}`} />
            <span className={`text-sm font-medium capitalize ${getCategoryColor(currentQuote.category)}`}>
