        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-semibold text-purple-800">Weekly Goal Progress</h3>
            </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <div className={`text-lg font-bold ${getMoodColor(averageMood)}`}>{averageMood.toFixed(1)}</div>
              <div className="text-sm text-muted-foreground">Average Mood</div>
            </div>

            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-2xl mb-2">📊</div>
              <div className="text-lg font-bold text-green-600">{totalMoodLogs}</div>
          ...
          {averageMood >= 3.5 && (
            <div className="mt-4 p-3 bg-green-100 rounded-lg border border-green-200">
              <div className="flex items-center space-x-2 text-green-700">
                ...
                <span className="font-medium">You're doing great! Your mood trend is positive.</span>
              </div>
            </div>
          )}

          {averageMood < 2.5 && totalMoodLogs >= 3 && (
            <div className="mt-4 p-3 bg-blue-100 rounded-lg border border-blue-200">
              <div className="flex items-center space-x-2 text-blue-700">
                <Heart className="h-4 w-4" />
                <span className="font-medium">
                  Remember, it's okay to have difficult days. Consider exploring our self-help tools.
                </span>
              </div>
            </div>
          )}
