...
export function BreathingExercise() {
  ...
  const cycleProgress = ((currentPhaseIndex * totalDuration + (currentPhase.duration - timeLeft)) / totalDuration) * 100
    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col items-center space-y-6">
          <div className="relative w-48 h-48 flex items-center justify-center">
            ...
            >
              <div className="text-center">
                <div className={`text-2xl font-bold ${getPhaseColor(currentPhase.phase)}`}>{timeLeft}</div>
          ...
          {/* Current Instruction */}
          <div className="text-center">
            <div className={`text-xl font-semibold ${getPhaseColor(currentPhase.phase)} capitalize`}>
              {currentPhase.phase}
            </div>
          ...
          <div className="flex items-center space-x-4">
            <Button
              onClick={isSoundEnabled ? () => setIsSoundEnabled(false) : () => setIsSoundEnabled(true)}
              variant="outline"
              size="sm"
            >
          ...
          {isCompleted && (
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="text-green-800 font-semibold mb-2">Exercise Complete!</div>
              <div className="text-green-700 text-sm">
                Great job! You've completed {selectedPattern.totalCycles} cycles of {selectedPattern.name}. Take a
