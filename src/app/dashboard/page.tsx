...
export default function DashboardPage() {
  ...
  const fetchUserStats = async () => {
    try {
      const [userResponse, moodResponse] = await Promise.all([fetch("/api/users"), fetch("/api/mood?limit=100")])
      ...
      if (userResponse.ok && moodResponse.ok) {
        ...
        const averageMood =
          moodData.moodLogs.length > 0
            ? moodData.moodLogs.reduce((acc: number, log: any) => acc + log.moodScore, 0) / moodData.moodLogs.length
            : 0
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {userStats && (
          <div className="mb-8">
            <StreakCelebration streakCount={userStats.streakCount} onStreakMilestone={handleStreakMilestone} />
          </div>
        )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-orange-50 to-red-50 border-orange-200">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-2xl font-bold text-orange-600">{userStats?.streakCount || 0}</div>
          ...
          <Card className="bg-gradient-to-br from-pink-50 to-rose-50 border-pink-200">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-2xl font-bold text-pink-600">{userStats?.totalMoodLogs || 0}</div>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            <CardContent className="p-4 text-center">
              <div className="flex items-center justify-center mb-2">
                <span className="text-2xl">{getMoodEmoji(userStats?.averageMood || 0)}</span>
              </div>
              <div className="text-2xl font-bold text-blue-600">{userStats?.averageMood.toFixed(1) || "0.0"}</div>
          ...
          <Card className="bg-gradient-to-br from-yellow-50 to-amber-50 border-yellow-200">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-2xl font-bold text-yellow-600">{userStats?.badges.length || 0}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            {/* Achievement System */}
            {userStats && <AchievementSystem userStats={userStats} onAchievementUnlocked={handleAchievementUnlocked} />}
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
              <CardContent className="p-6 text-center">
                ...
                <CardTitle className="text-lg mb-2 text-green-800">Breathing Exercise</CardTitle>
                <CardDescription className="text-green-600">Take 5 minutes to calm your mind</CardDescription>
                <Button className="mt-4 bg-green-600 hover:bg-green-700" variant="default" size="sm" asChild>
                  <Link href="/tools?tab=breathing">Start Exercise</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
              <CardContent className="p-6 text-center">
                ...
                <CardTitle className="text-lg mb-2 text-purple-800">Journal Writing</CardTitle>
                <CardDescription className="text-purple-600">Express your thoughts and feelings</CardDescription>
                <Button className="mt-4 bg-purple-600 hover:bg-purple-700" variant="default" size="sm" asChild>
                  <Link href="/tools?tab=journaling">Start Writing</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
              <CardContent className="p-6 text-center">
                ...
                <CardTitle className="text-lg mb-2 text-blue-800">Self-Assessment</CardTitle>
                <CardDescription className="text-blue-600">Check in with your mental health</CardDescription>
                <Button className="mt-4 bg-blue-600 hover:bg-blue-700" variant="default" size="sm" asChild>
                  <Link href="/tools?tab=assessment">Take Assessment</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
              <CardContent className="p-6 text-center">
                ...
                <CardTitle className="text-lg mb-2 text-amber-800">Browse Resources</CardTitle>
                <CardDescription className="text-amber-600">Find helpful articles and tools</CardDescription>
                <Button className="mt-4 bg-amber-600 hover:bg-amber-700" variant="default" size="sm" asChild>
