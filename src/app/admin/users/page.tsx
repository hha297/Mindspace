    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{usersData?.users.filter((u) => u.lastMoodLog).length || 0}</div>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {usersData?.users.length
                ? (usersData.users.reduce((sum, u) => sum + u.streakCount, 0) / usersData.users.length).toFixed(1)
                : "0.0"}
            </div>
                ...
                <TableRow key={user._id}>
                  ...
                  <TableCell>
                    <div className="flex items-center">
                      ...
                      <span className="font-medium">{user.streakCount}</span>
                    </div>
                  </TableCell>
                  <TableCell>
                    <Badge variant="secondary">{user.moodLogCount} logs</Badge>
                  </TableCell>
                  <TableCell>
                    {user.lastMoodLog ? (
                      <div className="text-sm text-muted-foreground">
                        {format(new Date(user.lastMoodLog), "MMM d, yyyy")}
                      </div>
                    ) : (
